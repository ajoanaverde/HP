...
<head>
	<meta charset="utf-8">
	<title>Salle Des Banquets</title>
	<link rel="stylesheet" type="text/css" href="styles.css"> 
</head>
<body id="banquets">
	<div id="home2">
		<header id="header2">
			<h1 class="titre2">Poudlard</h1>
			<h2 class="titre2">Accueil Dans La Salle Des Banquets</h2>
		</header>
        ...
        <div class="grid-container">
            ...
            <div class="grid-item">
                <a href="ep2.html">Suivre la visite</a>
                <a href="choixEp.html">Suivre la visite</a>
            </div>
            <div class="grid-item">8</div>
            <div class="grid-item item2">9</div>
            <div class="grid-item">10</div>
            <div class="grid-item">
                    <a href="">
                        <h4 class="emblemes" id="gryff">
                            <img src="emblemes/ravenclawNoir.png" alt="Emblême Raveclaw">
                        </h4>
                    </a>
                </div>
                <div class="grid-item">
                    <a href="">
                        <h4 class="emblemes" id="slyth">
                            <img src="emblemes/slytherinNoir.png" alt="Emblême Slytherin">
                        </h4>
                    </a>
                </div>  
                <div class="grid-item">
                    <a href="">
                        <h4 class="emblemes" id="huff">
                            <img src="emblemes/hufflepufNoir.png" alt="Emblême Hufflepuff">
                        </h4>
                    </a>
                </div>
                <div class="grid-item">
                    <a href="">
                        <h4 class="emblemes" id="rav">
                            <img src="emblemes/ravenclawNoir.png" alt="Emblême Ravenclaw">
                        </h4>
                    </a>
                </div>
