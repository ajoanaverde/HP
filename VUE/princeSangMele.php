...
?>
<body id="secrets">
	<div id="home6" class="home homeEp">
        <div class="bg-gris4">
            <?php
                ...
                <div class="col-6 item2" id="videoEp">
                    <figure><!--class="video2"-->
                        <figcaption class="videoEp">
                            Bande annonce <span>Harry Potter et le Prince de Sang-Mêlé' [Fr]</span>
                        </figcaption>
                        <div id="videoEp">
                            <video id="videoAccueil" width="" height="300" controls 
                                source src="./vid/Harry Potter et le Prince de Sang-Mêlé - Bande-annonce - VF.mp4" type="video/mp4">
            ...
            <div id="PrezEpisode" class="row">
                <h2 class="center bold">
                    Bienvenue pour votre dernière année à Poudlard !
                </h2>
                <div class="col-8 offset-2">
                    <p>
                        Votre professeur de défense contre les forces du mal cette année
                        sera <span class="bold">Severus Rogue</span>, et 
                        <span class="bold">Horace Slughorn</span>, notre ancien professeur 
                        de potions, revient parmi nous.
                        <p class="center bold">
